...
@section('title', __('View Token Sent Transaction'))
...
<div class="box box-default">
	<div class="box-body">
		<div class="d-flex justify-content-between">
			<div>
				<div class="top-bar-title padding-bottom pull-left">{{ __('Token Sent Transaction Details') }}</div>
			</div>
			<div>
                        ...
                        <div class="panel">
                            <div>
                                <div class="p-4">
                                    ...
                                    @if ($network)
                                        <div class="form-group row">
                                            <label class="control-label f-14 fw-bold text-sm-end col-sm-3" for="currency">{{ __('Crypto Network') }}</label>
                                            <div class="col-sm-9">
                                                <p class="form-control-static f-14">{{ $network->code }}</p>
                                            </div>
                                        </div>
                                    @endif
                            ...
                            <div>
                                <div class="p-4">
                                    ...
                                    <div class="form-group row total-deposit-feesTotal-space">
                                        ...
                                        <div class="col-sm-6">
                                            <p class="form-control-static f-14">
                                                {{ moneyFormat($network->symbol, isset($network_fee) ? formatNumber($network_fee, $transaction->currency) : formatNumber(0.00000000, $transaction->currency_id)) }}
                                            </p>
                                        </div>
                                    </div>
