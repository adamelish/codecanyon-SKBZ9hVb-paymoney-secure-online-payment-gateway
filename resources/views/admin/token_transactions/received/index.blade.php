...
@section('title', __('Token Received Transactions'))
...
@section('page_content')
    <div class="box">
        <div class="box-body pb-20">
            <form class="form-horizontal" action="{{ route('admin.token_received_transaction.index') }}" method="GET">
    ...
    <div class="row">
        <div class="col-md-8">
            <p class="panel-title text-bold ml-5 mb-0 f-14">{{ __('All Token Received Transactions') }}</p>
        </div>
        <div class="col-md-4">
...
<script type="text/javascript">
    ...
    var cryptoReceivedUserSearch = '{{ route("admin.token_received_transaction.search_user") }}';
    var csvUrl = ADMIN_URL + "/token-received-transactions/csv";
    var pdfUrl = ADMIN_URL + "/token-received-transactions/pdf";
</script>

<script src="{{ asset('Modules/TatumIo/Resources/assets/admin/js/token_received_transaction.min.js') }}" type="text/javascript"></script>
