              ...
              <div class="box-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <small class="form-text text-muted f-12"><strong>*{!! __('Insert your Google Analytics code. See the :x for details.', ['x' => '<a href="https://docs.paymoney.techvill.net/how-to-configure-google-analytics" target="_blank">'. __('Setup Guide') .'</a>']) !!}</strong></small>
                  </div>
                </div>
