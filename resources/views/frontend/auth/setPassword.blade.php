                        ...
                        <div class="bg-content">
                            ...
                            <div class="transaction-image">
                                <div class="static-image">
                                    <img class="img img-fluid" src="{{ asset('public/frontend/templates/images/login/signin-static.svg') }}" alt="{{ __('Logo') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="password">{{ __('New password') }} <span class="star">*</span></label>
                                            <div id="password-div" class="position-relative">
                                                <input type="password" class="form-control input-form-control" id="password" placeholder="{{ __('New Password') }}" name="password" required=""  data-value-missing="{{ __('This field is required.') }}">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="password_confirmation">{{ __('Confirm password') }} <span class="star">*</span></label>
                                            <input type="password" class="form-control input-form-control" id="password_confirmation" placeholder="{{ __('Confirm Password') }}" name="password_confirmation" required=""  data-value-missing="{{ __('This field is required.') }}">
                                        </div>
