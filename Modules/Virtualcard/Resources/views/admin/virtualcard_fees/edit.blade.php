...
@section('title', __('Edit Fees Limit'))
        ...
        <div class="col-md-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __('Edit Fees Limit') }}</h3>
                </div>
                <form method="post" action="{{ route('admin.card_fees.update', $cardFeesLimit->id) }}" class="form-horizontal" id="virtualCardFeesForm">
                    @csrf
                    @method('put')
                    <div class="box-body">
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                >
                                    @foreach ($cardProvider as $provider)
                                        <option {{ $provider['id'] == $cardFeesLimit->virtualcard_provider_id ? 'selected' : '' }} value="{{ $provider['id'] }}">{{ $provider['name'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        value="{{ isset($cardFeesLimit->card_creation_fee) ? number_format((float)$cardFeesLimit->card_creation_fee, $currencyType, '.', '') : '' }}"
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        value="{{ isset($cardFeesLimit->topup_fixed_fee) ? number_format((float)$cardFeesLimit->topup_fixed_fee, $currencyType, '.', '') : '' }}"
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        value="{{ isset($cardFeesLimit->topup_percentage_fee) ? number_format((float)$cardFeesLimit->topup_percentage_fee, $currencyType, '.', '') : '' }}"
                                        required data-value-missing="{{ __('This field is required.') }}"
                                        onkeypress="return isNumberOrDecimalPointKey(this,event)"
                                        oninput="restrictNumberToPrefdecimalOnInput(this)"
                                    >
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        placeholder="{{ __('Topup Min Limit') }}"
                                        value="{{ isset($cardFeesLimit->topup_min_limit) ? number_format((float)$cardFeesLimit->topup_min_limit, $currencyType, '.', '') : '' }}"
                                        required data-value-missing="{{ __('This field is required.') }}"
                                        onkeypress="return isNumberOrDecimalPointKey(this,event)"
                                        oninput="restrictNumberToPrefdecimalOnInput(this)"
                                    >
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        value="{{ isset($cardFeesLimit->topup_max_limit) ? number_format((float)$cardFeesLimit->topup_max_limit, $currencyType, '.', '') : '' }}"
                                        required data-value-missing="{{ __('This field is required.') }}"
                                        onkeypress="return isNumberOrDecimalPointKey(this,event)"
                                        oninput="restrictNumberToPrefdecimalOnInput(this)"
                                    >
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        value="{{ isset($cardFeesLimit->withdrawal_fixed_fee) ? number_format((float)$cardFeesLimit->withdrawal_fixed_fee, $currencyType, '.', '') : '' }}"
                                        required data-value-missing="{{ __('This field is required.') }}"
                                        onkeypress="return isNumberOrDecimalPointKey(this,event)"
                                        oninput="restrictNumberToPrefdecimalOnInput(this)"
                                    >
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        value="{{ isset($cardFeesLimit->withdrawal_percentage_fee) ? number_format((float)$cardFeesLimit->withdrawal_percentage_fee, $currencyType, '.', '') : '' }}"
                                        required data-value-missing="{{ __('This field is required.') }}"
                                        onkeypress="return isNumberOrDecimalPointKey(this,event)"
                                        oninput="restrictNumberToPrefdecimalOnInput(this)"
                                    >
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input
                                        ...
                                        required value="{{ isset($cardFeesLimit->withdrawal_min_limit) ? number_format((float)$cardFeesLimit->withdrawal_min_limit, $currencyType, '.', '') : '' }}"
                                        onkeypress="return isNumberOrDecimalPointKey(this,event)"
                                        oninput="restrictNumberToPrefdecimalOnInput(this)"
                                    >
                            ...
                            <div class="col-sm-6">
                                <div class="justify-content-between">
                                    <input t
                                        ...
                                        required data-value-missing="{{ __('This field is required.') }}"
                                        value="{{ isset($cardFeesLimit->withdrawal_max_limit) ? number_format((float)$cardFeesLimit->withdrawal_max_limit, $currencyType, '.', '') : '' }}"
                                        onkeypress="return isNumberOrDecimalPointKey(this,event)"
                                        oninput="restrictNumberToPrefdecimalOnInput(this)"
                                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <select
                                    ...
                                    required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')"
                                >
                                    <option value='Active' {{ $cardFeesLimit->status == 'Active' ? 'selected' : '' }}>{{ __('Active') }}</option>
                                    <option value='Inactive' {{ $cardFeesLimit->status == 'Inactive' ? 'selected' : '' }}>{{ __('Inactive') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 offset-md-3">
                                ...
                                @if(Common::has_permission(\Auth::guard('admin')->user()->id, 'edit_card_fees_limit'))
                                <button type="submit" class="btn btn-theme f-14 float-right" id="virtualCardFeesSubmitBtn">
                                    <i class="fa fa-spinner fa-spin d-none"></i>
                                    <span id="virtualCardFeesSubmitBtnText">{{ __('Update') }}</span>
                                </button>
                                @endif
                            </div>
                        </div>
...
@push('extra_body_scripts')
    ...
    <script>
        ...
        var selectedCurrency = "{{ $cardFeesLimit->virtualcard_currency_code }}";
        var providerId       = '';
    </script>
