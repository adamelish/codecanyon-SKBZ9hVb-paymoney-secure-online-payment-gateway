    ...
    <div class="d-flex justify-content-between transac-child">
        <div class="d-flex w-50">
            <div class="deposit-circle d-flex justify-content-center align-items-center">
                <img src="{{ virtualcardImage($transaction->transaction_type->name) }}" alt="{{ __('Transaction') }}">
            </div>
            ...
            <div class="ml-20 r-ml-8">
                ...
                <div class="d-flex flex-wrap">
                    <p class="mb-0 text-gray-100 f-13 leading-17 gilroy-regular tran-title mt-2">{{ virtualcardPaymentDetails($transaction->transaction_reference_id, $transaction->transaction_type_id)->virtualcard?->currency_code ." " . __('Wallet') }}</p>
                ...
                <div class="d-flex position-relative modal-res">
                    ...
                    <div class="deposit-transac d-flex flex-column justify-content-center p-4 text-wrap">
                        <div class="d-flex justify-content-center text-primary align-items-center transac-img">
                            <img src="{{ virtualcardImage($transaction->transaction_type->name) }}" alt="{{ __('Transaction') }}" class="img-fluid">
                        </div>
                        <p class="mb-0 mt-28 text-dark gilroy-medium f-15 r-f-12 r-mt-18 text-center">{{ str_replace('_', ' ', $transaction->transaction_type?->name) }}&nbsp;{{ __('Amount') }}</p>
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="{{ $transaction->transaction_type_id == Virtualcard_Topup ? route('user.topup.print', $transaction->transaction_reference_id) : route('user.virtualcard_withdrawal.pdf', $transaction->transaction_reference_id) }}" class="infoBtn-print cursor-pointer f-14 gilroy-medium text-dark mt-35 d-flex justify-content-center align-items-center">{!! svgIcons('printer') !!}&nbsp;<span>{{ __('Print') }}</span>
                            </a>
                        </div>
                    </div>
                    <div class="ml-20 trans-details">
                        ...
                        <div class="row gx-sm-5">
                            <div class="col-6">
                                ...
                                <p class="mb-0 mt-5p text-dark gilroy-medium f-15 leading-22 r-text">{{ virtualcardPaymentDetails($transaction->transaction_reference_id, $transaction->transaction_type_id)->virtualcard?->currency_code }}</p>
                            </div>
                            <div class="col-6">
                                <p class="mb-0 mt-4 text-gray-100 gilroy-medium f-13 leading-20 r-f-9 r-mt-11">{{ __('Card Brand') }}</p>
                                <p class="mb-0 mt-5p text-dark gilroy-medium f-15 leading-22 r-text">{{ virtualcardPaymentDetails($transaction->transaction_reference_id, $transaction->transaction_type_id)->virtualcard?->card_brand }}</p>
                            </div>
                        </div>
                        <div class="row gx-sm-5">
                            <div class="col-6">
                        ...
                        <div class="row gx-sm-5">
                            <div class="col-6">
                                ...
                                <p class="mb-0 mt-5p text-dark gilroy-medium f-15 leading-22 r-text">{{ maskCardNumber(virtualcardPaymentDetails($transaction->transaction_reference_id, $transaction->transaction_type_id)->virtualcard?->card_number) ?? '-' }}</p>
                            </div>
                            <div class="col-6">
                                <p class="mb-0 mt-20 text-gray-100 gilroy-medium f-13 leading-20 r-f-9 r-mt-11">{{ __('Status') }}</p>
                                <p class="mb-0 mt-5p {{ getColor($transaction->status) }} gilroy-medium f-15 leading-22 r-text">{{ getStatus($transaction->status) }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row gx-sm-5">
                            ...
                            <!-- Amount -->
                            <div class="col-6">
                                <p class="mb-0 mt-4 text-gray-100 dark-B87 gilroy-medium f-13 leading-20 r-f-9 r-mt-11">{{ __('Topup Amount') }}</p>
