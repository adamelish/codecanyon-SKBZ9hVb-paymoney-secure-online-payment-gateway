    ...
    <table class="tabl-width">
        <tbody>
            ...
            <tr>
                ...
                <td class="px-30 pb-24 align-rigt">
                    <span class="text-sm">{{ __('Confirmation') }}</span>
            ...
            <tr>
                <td class="px-30 pb-24">
                    <span class="text-sm">{{ __('Token') }}</span>
                    <h2 class="text-lg">{{ optional($transaction->currency)->symbol }}</h2>
                </td>
                <td class="px-30 pb-24 align-rigt">
                    <span class="text-sm">{{ __('Network') }}</span>
                    <h2 class="text-lg">{{ $network }}</h2>
                </td>
            </tr>

            <tr>
                <td class="px-30 pb-24">
                    <span class="text-sm">{{ __('TxId') }}</span>
                    <h2 class="text-lg">{{ $txId }}</h2>
                </td>
            </tr>
    ...
    <table class="tabl-width">
        <tbody>
            ...
            <tr>
                ...
                <td class="pb-10 pl-30 align-center">
                    <p class="text-md">{{ moneyFormat($network, formatNumber($network_fee, $transaction->currency_id)) }}</p>
                </td>
            </tr>
            <tr>
