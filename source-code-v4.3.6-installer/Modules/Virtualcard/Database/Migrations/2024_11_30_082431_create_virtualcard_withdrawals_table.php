...
class CreateVirtualcardWithdrawalsTable extends Migration
{
    /**
     * Run the migrations.
     */
    ...
    {
        Schema::create('virtualcard_withdrawals', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamp('fund_release_time')->nullable();
    ...
    {
        Schema::dropIfExists('virtualcard_withdrawals');
    }
}
