...
class PermissionRoleSeeder extends Seeder
{
    ...
    {
        $adminPermissions = \App\Models\Permission::whereIn('group', config('virtualcard.permission_group'))
        ...
        $userPermissions = \App\Models\Permission::whereIn('group', config('virtualcard.permission_group'))
