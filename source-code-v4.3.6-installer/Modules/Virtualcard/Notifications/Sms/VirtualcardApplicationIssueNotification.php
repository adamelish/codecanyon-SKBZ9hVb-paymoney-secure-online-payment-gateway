...
class VirtualcardApplicationIssueNotification extends TechVillageSms
{
    /**
    ...
    {
        try {
            $response = $this->getSmsTemplate('notify-user-on-virtual-card-issue');
            ...
            sendSMS($applicationData->virtualcardHolder?->user?->formattedPhone, $message);
        } catch (Exception $e) {
