...
class VirtualcardApplicationNotification extends TechVillageMail
{
    /**
    ...
    public function send($applicationData, $optional = [])
    {
        ...
        try {
            $response = $this->getEmailTemplate('notify-admin-on-new-virtual-card-application');
            ...
            $data = [
                ...
                '{user}'      => getColumnValue($applicationData->user),
                '{type}'      => ucfirst($applicationData->card_holder_type),
