...
Route::group(config('addons.route_group.authenticated.admin'), function()
{
    ...
    Route::post('tatumio/store', 'Admin\TatumIoAssetSettingController@store')->name('admin.tatumio_asset.store')->middleware('permission:add_crypto_asset')->middleware('demo_check');
    ...
    Route::post('tatumio/update/{network}', 'Admin\TatumIoAssetSettingController@update')->name('admin.tatumio_asset.update')->middleware('permission:edit_crypto_asset')->middleware('demo_check');
    ...
    Route::post('tatumio/webhook/store', 'Admin\TatumIoAssetSettingController@webhookStore')->name('admin.tatumio_asset.webhookstore')->middleware('demo_check');
    Route::get('tatumio/webhook/{network}/{id}', 'Admin\TatumIoAssetSettingController@webhookRemove')->name('admin.tatumio_asset.webhookremove')->middleware('demo_check');
    ...
    Route::post('tatumio/crypto-send/confirm', 'Admin\CryptoSendReceiveController@eachUserCryptoSentConfirm')->name('admin.tatum.crypto_send.confirm')->middleware('demo_check');
    Route::post('tatumio/crypto-send/success', 'Admin\CryptoSendReceiveController@eachUserCryptoSentSuccess')->name('admin.tatum.crypto_send.success')->middleware('demo_check');
    ...
    Route::post('tatumio/crypto-receive/confirm', 'Admin\CryptoSendReceiveController@eachUserCryptoReceiveConfirm')->name('admin.tatum.crypto_receive.confirm')->middleware('demo_check');
    Route::post('tatumio/crypto-receive/success', 'Admin\CryptoSendReceiveController@eachUserCryptoReceiveSuccess')->name('admin.tatum.crypto_receive.success')->middleware('demo_check');
    ...
    Route::post('crypto-token/store', 'Admin\TatumIoTokenController@store')->name('admin.tatumio.token.store')->middleware('permission:add_crypto_token')->middleware('demo_check');
    ...
    Route::post('crypto-token/update/{id}', 'Admin\TatumIoTokenController@update')->name('admin.tatumio.token.update')->middleware('permission:edit_crypto_token')->middleware('demo_check');
    Route::get('crypto-token/adjust', 'Admin\TatumIoTokenController@adjust')->name('admin.tatumio.token.adjust')->middleware('permission:edit_crypto_token')->middleware('demo_check');
    ...
    Route::post('crypto-token/token-send-confirm', 'Admin\TatumIoTokenSendController@tokenSendconfirm')->name('admin.tatum.token_send.confirm')->middleware('demo_check');
    Route::post('crypto-token/token-send-success', 'Admin\TatumIoTokenSendController@tokenSendSuccess')->name('admin.tatum.token_send.success')->middleware('demo_check');
    ...
    Route::post('crypto-token/token-receive-confirm', 'Admin\TatumIoTokenSendController@tokenReceiveConfirm')->name('admin.tatum.token_receive.confirm')->middleware('demo_check');
    Route::post('crypto-token/token-receive-success', 'Admin\TatumIoTokenSendController@tokenReceiveSuccess')->name('admin.tatum.token_receive.success')->middleware('demo_check');
...
Route::group(config('addons.route_group.authenticated.user'), function()
{
    ...
    Route::prefix('crypto/send/tatumio')->as('tatumio.user.crypto_send.')->namespace('Users')->middleware('permission:manage_crypto_send_receive')->group(function() {
        ...
        Route::post('success', 'CryptoSendController@sendCryptoSuccess')->name('success')->middleware('demo_check');
    ...
    Route::prefix('token/send/tatumio')->as('tatumio.user.token_send.')->namespace('Users')->middleware('permission:manage_crypto_send_receive')->group(function() {
        ...
        Route::post('success', 'TokenSendController@sendTokenSuccess')->name('success')->middleware('demo_check');
