...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $adminPermissions = \App\Models\Permission::whereIn('group', config('tatumio.permission_group'))
        ...
        $userPermissions = \App\Models\Permission::whereIn('group', config('tatumio.permission_group'))
