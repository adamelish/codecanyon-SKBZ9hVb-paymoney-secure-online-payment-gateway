...
@section('title', __('Token Receive Success'))
                    ...
                    <div class="col-md-7">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <h5 class="text-center f-14 mt-1">{{ __('Received Amount: :x', ['x' => moneyFormat($currencySymbol, tokenFormat($amount, $token_decimals))]) }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ route('admin.tatumio.token.receive', ['network' => encrypt($network), 'tokenid' => encrypt($tokenId) ]) }}" class="btn btn-theme"><strong>{{ __('Receive :x Again', ['x' => $walletCurrencyCode]) }}</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
