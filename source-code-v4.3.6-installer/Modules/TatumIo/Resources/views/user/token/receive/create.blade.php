...
<div class="text-center">
    <p class="mb-0 gilroy-Semibold f-26 text-dark theme-tran r-f-20 text-uppercase">
        {{ __('Receive :x (:y)', ['x' => strtoupper($cryptoToken->name), 'y' => (strtoupper($walletCurrencyCode))]) }}
    </p>
</div>
            ...
            <form method="POST" action="" id="transfer_form">
                ...
                <div class="express-merchant-qr-section ">
                    ...
                    <div class="d-flex justify-content-center mt-56">
                        <p class="mb-0 f-14 leading-22 text-dark gilroy-medium text-center mt-5p">{!! __('Only receive token balance of <b> :x </b> to this address, receiving any other Token will result in permanent loss.', ['x' => strtoupper($walletCurrencyCode)]) !!}</p>
                    </div>
