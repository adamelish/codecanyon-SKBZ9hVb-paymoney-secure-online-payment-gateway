...
<script src="{{ asset('public/dist/libraries/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ asset('public/dist/plugins/select2/js/select2.min.js') }}"></script>
