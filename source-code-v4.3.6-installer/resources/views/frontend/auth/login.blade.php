                            ...
                            <form action="{{ url('authenticate') }}" method="post" id="login-form">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        @if (isset($setting['login_via']) && $setting['login_via'] == 'email_only')
                                            <div class="form-group mb-3">
                                                ...
                                                @if (checkDemoEnvironment())
                                                    value="{{ old('email_only', 'kyla@gmail.com') }}"
                                                @endif
                                                >
                                                @error('email_only')
                                        ...
                                        @if (checkDemoEnvironment())
                                        <div class="text-lg d-flex align-items-center mt-2 mb-3">
                                            <hr class="border hr-border-color w-100">
                    
                                            <p class="px-3 text-nowrap demo-text">
                                        ...
                                        <div  class="row mb-5">
                                            <div class="col-4">
                                                <button type="button" class="w-100 btn btn-lg btn-primary demo-login" data-login="user"> {{ __('User') }} </button>
                                            </div>
                                            <div class="col-4">
                                                <button type="button" class="w-100 btn btn-lg btn-primary demo-login" data-login="merchant"> {{ __('Merchant') }} </button>
                                            </div>
                                           <div class="col-4 pe-0">
                                                <a href="{{ url('admin?demo=true') }}" class="w-100 btn btn-lg btn-primary" id="admin-login"> {{ __('Admin') }} </a>
                                           </div>
                                        </div>
                                        @endif
                                    </div>
