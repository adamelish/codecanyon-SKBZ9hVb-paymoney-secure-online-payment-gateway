...
@section('head_style')
  <!-- summernote -->
  <link rel="stylesheet" type="text/css" href="{{ asset('public/dist/libraries/summernote/dist/summernote-lite.min.css')}}">
@endsection
...
<script src="{{ asset('public/dist/libraries/summernote/dist/summernote-lite.min.js')}}" type="text/javascript"></script>
