...
class TokenSendsExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
    public function query()
    {
        ...
        $getCryptoSentTransactions = (new \App\Models\Transaction())->getCryptoSentTransactions($from, $to, $status, $currency, $user, Token_Sent)->orderBy('transactions.id', 'desc');
