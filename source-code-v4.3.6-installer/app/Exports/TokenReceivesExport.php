...
class TokenReceivesExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles
{
    public function query()
    {
        ...
        $getCryptoReceivedTransactions = (new Transaction())->getCryptoReceivedTransactions($from, $to, $currency, $user, Token_Received)->orderBy('transactions.id', 'desc');
    ...
    public function map($getCryptoReceivedTransactions): array
    {
        return [
            ...
            optional($getCryptoReceivedTransactions->currency)->code,
