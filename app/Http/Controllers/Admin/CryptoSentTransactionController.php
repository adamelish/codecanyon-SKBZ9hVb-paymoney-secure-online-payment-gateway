...
use App\Exports\CryptoSendsExport;
...
class CryptoSentTransactionController extends Controller
{
    ...
    public function index(CryptoSentTransactionsDataTable $dataTable)
    {
        ...
        $data['cryptoSentTransactionsStatus'] = $cryptoSentTransactions->select('status')->distinct()->get();
    ...
    {
        return Excel::download(new CryptoSendsExport(), 'crypto_sent_transactions_list_' . time() . '.csv');
    }
    ...
    public function cryptoSentTransactionsPdf()
    {
        ...
        generatePDF('admin.crypto_transactions.sent.crypto_sent_transactions_report_pdf', 'cyprto_sent_transactions_report_', $data);
    }
}