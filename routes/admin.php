...
Route::group(['middleware' => ['guest:admin', 'locale', 'ip_middleware']], function ()
{
    ...
    Route::post('change-password', 'AdminController@updatePassword')->middleware('demo_check');
    ...
    Route::post('users/update', 'UserController@update')->middleware('demo_check');
    Route::get('users/delete/{id}', 'UserController@destroy')->middleware(['permission:delete_role', 'demo_check']);
    ...
    // Token Send Transactions details
    Route::get('token-sent-transactions', 'TokenSentTransactionController@index')->name('admin.token_sent_transaction.index')->middleware('permission:view_token_transactions');
    Route::get('token-sent-transactions/csv', 'TokenSentTransactionController@tokenSentTransactionsCsv')->name('admin.token_sent_transaction.csv');
    Route::get('token-sent-transactions/pdf', 'TokenSentTransactionController@tokenSentTransactionsPdf')->name('admin.token_sent_transaction.pdf');
    Route::get('token-sent-transactions/view/{id}', 'TokenSentTransactionController@view')->name('admin.token_sent_transaction.view')->middleware('permission:view_token_transactions');
    Route::get('token-sent-transactions/search/user', 'TokenSentTransactionController@tokenSentTransactionsSearchUser')->name('admin.token_sent_transaction.search_user');

    // Token Receive Transactions
    Route::get('token-received-transactions', 'TokenReceivedTransactionController@index')->name('admin.token_received_transaction.index')->middleware('permission:view_token_transactions');
    Route::get('token-received-transactions/csv', 'TokenReceivedTransactionController@tokenReceivedTransactionsCsv')->name('admin.token_received_transaction.csv');
    Route::get('token-received-transactions/pdf', 'TokenReceivedTransactionController@tokenReceivedTransactionsPdf')->name('admin.token_received_transaction.pdf');
    Route::get('token-received-transactions/view/{id}', 'TokenReceivedTransactionController@view')->name('admin.token_received_transaction.view')->middleware('permission:view_token_transactions');
    Route::get('token-received-transactions/search/user', 'TokenReceivedTransactionController@tokenReceivedTransactionsSearchUser')->name('admin.token_received_transaction.search_user');
    ...
    Route::post('admin-users/update', 'UserController@adminUpdate')->middleware('demo_check');
    Route::get('admin-user/delete/{id}', 'UserController@adminDestroy')->middleware(['permission:delete_admin', 'demo_check']);
    ...
    Route::get('settings/delete_currency/{id}', 'CurrencyController@delete')->middleware(['permission:delete_currency'])->middleware('demo_check');
    ...
    Route::match(['get', 'post'], 'settings/admin-security-settings', 'SettingController@adminSecuritySettings')->middleware(['permission:view_admin_security', 'demo_check']);
    ...
    Route::match(array('GET', 'POST'), 'settings/edit_user_role/{id}', 'UsersRoleController@update')->middleware(['permission:edit_group', 'demo_check']);
